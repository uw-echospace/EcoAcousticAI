...
class NABat_DB:
    ...
    def __init__(self, path='db0', class_list=None):
    ...
    def get_training_files(self, file_id=None, file_name=None):
    ...
    def get_classification_files(self):
        return self.fastQuery(
            """ 
                with x as (
    ...
    def add_training_file(self, name, duration, sample_rate, manual_id, grts_id, draw=None):
    ...
    def add_classification_file(self, name, duration, sample_rate, grts_id):
        return self.insert(
            "INSERT INTO file (name, duration, sample_rate, grts_id) VALUES (?,?,?,?);", (name, duration, sample_rate, grts_id))
    

    def add_training_pulse(self, file_id, frequency, amplitude, sig_noise, offset, time,  window, path):
        return self.insert(
    ...
    def add_classification_pulse(self, file_id, frequency, amplitude, sig_noise, offset, time,  window):
        return self.insert(
    ...
    def add_training_predictions(self, data):
        self.conn.executemany(
            "insert into prediction (model_name, pulse_id, confidence, species_id) values (?,?,?,?);", data)
        self.conn.execute('commit;')

    def add_classification_predictions(self, values):
        self.conn.executemany(
